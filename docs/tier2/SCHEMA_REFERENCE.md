# Tier 2 Schema Reference

This document provides exhaustive field-by-field documentation for the Tier 2 daily parquet exports.

For an introduction to the dataset, quick start examples, and file layout, see [README_TIER2.md](README_TIER2.md).
...
| `twitter_sentiment_last_cycle` | struct | X (Twitter) sentiment data from the most recent scraping cycle. Contains post counts, AI sentiment, engagement metrics, author stats, and more. See [twitter_sentiment_last_cycle](#twitter_sentiment_last_cycle) for full field details |
...
| `struct` | Nested object with named fields |
